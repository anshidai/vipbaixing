...
<header id="masthead" class="site-header">
  <nav id="top-header">
    <div class="top-nav">
      <div id="user-profile"> 聪明人已经记住域名 WWW.vipbaixing.COM
        <?php 
		if( dopt('d_sign_b') ){ 
			global $current_user; 
			get_currentuserinfo();
    ...
    <div id="top-menu">
      <div id="top-menu_1"><span class="nav-search"><i class="fa fa-search"></i></span> <span class="nav-search_1"><a href="#nav-search_1"><i class="fa fa-navicon"></i></a></span>
        <hgroup class="logo-site">
          <h1 class="site-title"> <a href="/"><img src="<?php bloginfo('template_url'); ?>/img/logo.png" alt="Cui 2.0博客主题" /></a></h1>
        </hgroup>
