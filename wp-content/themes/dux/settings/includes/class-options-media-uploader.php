...
class Options_Framework_Media_Uploader
{
	...
	static public function optionsframework_uploader($_id, $_value, $_desc = "", $_name = "")
	{
	...
	public function optionsframework_media_scripts($hook)
	{
		...
		wp_localize_script("of-media-uploader", "optionsframework_l10n", array("upload" => __("Upload", "textdomain"), "remove" => __("Remove", "textdomain")));
	}
}
